...
<html>
  <head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('./images/logo_sumutprov_baru.png') }}">

    <!-- Compressed Styles -->
    <link href="{{ asset('frontend/css/slides.min.css?41331') }}" rel="stylesheet" type="text/css" />
    ...
    <!-- Compressed Scripts -->
    <script src="{{ asset('frontend/js/slides.min.js?41331" type="text/javascript') }}"></script>
  ...
  <body class="slides chain simplifiedMobile animated">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" style="display: none">
      <symbol id="logo" viewBox="0 0 106 31">
        ...
        {{-- <symbol id="logo" viewBox="0 0 2000 500"> <!-- Lebar & tinggi diperbesar -->
      ...
      <div class="sections">
        <div class="center">
          <a href="#" class="opacity-8"
            >Available <svg style="height: 21px"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#apple"></use></svg> iPhone</a
          >
        </div>
      </div>
    </nav>
